...
use Ibexa\Contracts\Migration\Bootstrapper\MigrationHook;
 ...
 *
 * Typed against the generic {@see KernelInterface}, not {@see IbexaTestKernelInterface}
 * — kernels are expected to move away from this method over time, so this provider treats it the
 * same way {@see MigrationHook} already treats its own
